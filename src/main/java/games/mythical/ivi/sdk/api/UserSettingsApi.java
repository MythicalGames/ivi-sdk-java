...
public class UserSettingsApi {
  ...
  public ThemeDto getTheme() throws ApiException {
    ApiResponse<ThemeDto> localVarResponse = getThemeWithHttpInfo();
  ...
  public ApiResponse<ThemeDto> getThemeWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getThemeRequestBuilder();
    try {
      ...
      return new ApiResponse<ThemeDto>(
  ...
  private HttpRequest.Builder getThemeRequestBuilder() throws ApiException {
  ...
  public ApiResponse<Void> setThemeWithHttpInfo(String body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = setThemeRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder setThemeRequestBuilder(String body) throws ApiException {
  ...
  public ApiResponse<Void> updateThemeWithHttpInfo(String body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateThemeRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder updateThemeRequestBuilder(String body) throws ApiException {

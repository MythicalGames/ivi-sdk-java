...
import games.mythical.ivi.sdk.invoker.auth.Authentication;
import games.mythical.ivi.sdk.invoker.auth.HttpBasicAuth;
import games.mythical.ivi.sdk.invoker.auth.HttpBearerAuth;
import games.mythical.ivi.sdk.invoker.auth.ApiKeyAuth;
import games.mythical.ivi.sdk.invoker.auth.OAuth;
import games.mythical.ivi.sdk.invoker.auth.RetryingOAuth;
import games.mythical.ivi.sdk.invoker.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("spring_oauth", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://accounts.mythical.games/realms/mythical-dev/protocol/openid-connect/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/unspecified/java");

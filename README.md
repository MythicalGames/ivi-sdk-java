...
- Build date: 2020-09-15T00:43:19.928192-07:00[America/Los_Angeles]
...
```groovy
compile "games.mythical:ivi-engine-sdk:1.0-SNAPSHOT"
```
...
- `target/ivi-engine-sdk-1.0-SNAPSHOT.jar`
- `target/lib/*.jar`

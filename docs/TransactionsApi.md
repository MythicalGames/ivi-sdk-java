...
[**getAllTitleTransactionsWithHttpInfo**](TransactionsApi.md#getAllTitleTransactionsWithHttpInfo) | **GET** /environments/{environmentId}/transactions | Get all transaction events for an environment.
...
[**getTransactionEventsForTitleWithHttpInfo**](TransactionsApi.md#getTransactionEventsForTitleWithHttpInfo) | **GET** /environments/{environmentId}/transactions/{transactionId} | Get transaction events for transaction ID in an environment.
...
## getAllTitleTransactionsWithHttpInfo

> ApiResponse<List<TransactionEventDTO>> getAllTitleTransactions getAllTitleTransactionsWithHttpInfo(environmentId, from, to, cursor)
...
public class Example {
    public static void main(String[] args) {
        ...
        String cursor = "cursor_example"; // String | 
        try {
            ApiResponse<List<TransactionEventDTO>> response = apiInstance.getAllTitleTransactionsWithHttpInfo(environmentId, from, to, cursor);
...
ApiResponse<[**List&lt;TransactionEventDTO&gt;**](TransactionEventDTO.md)>
...
## getTransactionEventsForTitleWithHttpInfo

> ApiResponse<List<TransactionEventDTO>> getTransactionEventsForTitle getTransactionEventsForTitleWithHttpInfo(environmentId, transactionId, cursor)
...
public class Example {
    public static void main(String[] args) {
        ...
        String cursor = "cursor_example"; // String | 
        try {
            ApiResponse<List<TransactionEventDTO>> response = apiInstance.getTransactionEventsForTitleWithHttpInfo(environmentId, transactionId, cursor);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
